    ...
    module: {
        ...
        rules: [
            ...
            },
            {
                ...
                include: [paths.code, path.join(__dirname, "..", "node_modules", "query-string"), path.join(__dirname, "..", "node_modules", "strict-uri-encode"), path.join(__dirname, "..", "node_modules", "split-on-first")]
            }
        ].concat(prod ? [{
            test: /\.html$/,
            loader: 'html-loader'
